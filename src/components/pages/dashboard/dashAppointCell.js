...
export default class dashAppointCell extends Component {
  ...
  render() {
    ...
    return (
      <Animated.View style={[styles.dashCell, { width: width - 40, height: this.state.AnimHeight }]}>
        <TouchableOpacity activeOpacity={1} onPress={() => {this.slideDown()}} style={{overflow: 'hidden', flex: 1, flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-start', borderColor: 'purple', borderWidth: WIDTH, height: this.state.isOpen? 300: 80}}> 
              <View style={[styles.rect,]} />
              <View style={{flex: 1, alignSelf: 'flex-start', overflow: 'hidden', borderColor: 'green', borderWidth: WIDTH, height: this.state.isOpen? 300: 80}}>
                    <View style={styles.dashInfo}>
                      <View style={{ flexDirection: 'row', flex: 1, width: width-74 }}>
                        ...
                        <Text style={{ color: '#6999FD', fontSize: 15, fontWeight: 'bold', marginRight: 15, }}>8天后</Text>
                      </View>
                      <View style={{flexDirection: 'row', borderColor: 'black', borderWidth: WIDTH}}>
                        <Text style={{ color: '#9E9E9E', fontSize: 16, flex: 1 }}>{add}  {date}</Text>
                    ...
                    ?<View style={styles.filesContainer}>
                        <View style={styles.titleCell}>
                            <Text style={{color: '#B0B0B0',}}>· 准备资料 ·</Text>
                        </View>
                        <View style={styles.titleCell}>
                            <Text style={{color: 'black', lineHeight: 18}}>原件及复印件:{"\n"}户口本、身份证、学生证、在校证明</Text>
                        </View>
                        <View style={styles.titleCell}>
                            <Text style={{color: 'black', lineHeight: 18}}>小一寸照片 * 1</Text>
                        </View>
                        <View style={styles.titleCell}>
                            <Text style={{color: 'black', lineHeight: 18}}>居住证相片回执</Text>
                        </View>
                        <View style={styles.titleCell}>
                            <Text style={{color: 'black', lineHeight: 18}}>居住证工本费200元</Text>
                        </View>
                    </View>
                    :null}
                    {this.state.isOpen 
